...
const PRODUCT_META = {
  ...
  postres_kit: {
    ...
    muted: '#6E5A61',
    lineSoft: '#EFE4E8',
    productName: 'Mini Postres Fríos Sin Horno',
    brandLine: 'Mini Postres Fríos',
    badge: 'Compra confirmada',
    title: 'Tu acceso ya está listo',
    lead:
      'Método de 3 bases, precios y catálogo para vender mini postres fríos por WhatsApp. Entra con el mismo correo de la compra.',
    hero: '/email/postres-hero.jpg',
    heroAlt: 'Mini postres fríos sin horno',
    bullets: [
      '3 bases → sabores listos para fotografiar',
  ...
  postres_premium: {
    ...
    muted: '#6E5A61',
    lineSoft: '#EFE4E8',
    productName: 'Mini Postres Premium',
    brandLine: 'Mini Postres Fríos',
    badge: 'Premium activado',
    title: 'Tu Premium ya está activo',
    lead:
    ...
    heroAlt: 'Mini postres premium',
    bullets: [
      'Más sabores e ideas dentro de la app',
